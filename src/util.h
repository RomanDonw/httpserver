...
static inline bool isoutofbound(const void *inbuffptr, const void *onbuffptr, size_t buffsize)
{ return inbuffptr - onbuffptr >= buffsize || inbuffptr < onbuffptr; }

static inline bool memfcmp(const void *data1, size_t size1, const void *data2, size_t size2)
{
